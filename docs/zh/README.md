...
本文档由 [Websoft9](http://www.websoft9.com/) 公司提供，用于指导用户学习 Redis 的安装部署与基本运维技术，包括：Redis部署、初始化安装、环境配置、HTTPS、SMTP、备份升级和连接云服务器操作等基本操作。
...
![Redis界面](https://libs.websoft9.com/Websoft9/DocsPicture/zh/redis-gui-websoft9.png)
